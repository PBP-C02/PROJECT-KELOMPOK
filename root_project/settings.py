...
SECRET_KEY = 'django-insecure-eo7&#itvh9^p$an(l9vuy0!jbc&2y*l^athh0iwh-k$2a1geul'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "ari-darrell-movebuddy.pbp.cs.ui.ac.id", "10.0.2.2"]
